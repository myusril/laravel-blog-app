        ...
        <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <a href="/dashboard/categories/add"
                    ...
                    <div class="flex items-center space-x-3 w-full md:w-auto">
                        ...
                        <div id="actionsDropdown"
                            ...
                            <ul class="py-1 text-sm text-gray-700" aria-labelledby="actionsDropdownButton">
                                <li>
                                    <a href="#" class="block py-2 px-4 hover:bg-gray-100">Name</a>
                                </li>
                            </ul>
                            <div class="py-1">
                                <a href="#"
                                    class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Date</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div id="{{ $category->id }}-dropdown"
                                        ...
                                        <div class="py-1">
                                            <a href="#"
                                                onclick="event.preventDefault(); document.getElementById('delete-category').submit();"
                                                class="block py-2 px-4 text-sm text-red-700 hover:bg-red-100">Delete</a>
                                            <form id="delete-category"
                                                action="/dashboard/categories/delete/{{ $category->id }}" method="POST"
                                                class="hidden">
                                                @csrf
                                            </form>
                                        </div>
