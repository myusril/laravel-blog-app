                        ...
                        @foreach ($posts as $post)
                            <tr class="border-b">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
                                    {{ Str::limit($post->title, 15, '...') }}</th>
                                <td class="px-4 py-3">{{ Str::limit($post->slug, 15, '...') }}</td>
                                <td class="px-4 py-3">{{ Str::limit($post->body, 15, '...') }}</td>
                                <td class="px-4 py-3">
                                    ...
                                    <div id="{{ $post->id }}-dropdown"
                                        ...
                                        <div class="py-1">
                                            <a href="#"
                                                ...
                                                class="block py-2 px-4 text-sm text-red-700 hover:bg-red-100">Delete</a>
                                            <form id="delete-post"
                                                action="/dashboard/posts/delete/{{ $post->id }}" method="POST"
                                                class="hidden">
                                                @csrf
                                            </form>
                                        </div>
